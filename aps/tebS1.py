...
title='TT,EE and BB power spectra of GALFACTS DR3.1 S1 map, chunk {0}'.format(chunk)
ax.set_title(title)
...
if scale == 'dl':
    fig.savefig("S1_aps_dqa3.1_c"+str(chunk)+"_dl_eqaxes.pdf",dpi=100)
else:
    fig.savefig("S1_aps_dqa3.1_c"+str(chunk)+"_cl.pdf",dpi=100)
plt.show()
