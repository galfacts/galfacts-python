...
f1 = aplpy.FITSFigure('N4_galfacts_q_corrected.fits', figure=fig,
                      subplot=[0.1, 0.4, 0.38, 0.2])

f1.tick_labels.set_font(size='x-small')
f1.axis_labels.set_font(size='small')
f1.add_label(0.15,0.85,'GALFACTS Q (N4)',relative=True,size='large',layer='title')
...
f2 = aplpy.FITSFigure('wolQN4.fits', figure=fig,
                      subplot=[0.1, 0.1, 0.38, 0.2])

f2.tick_labels.set_font(size='x-small')
f2.axis_labels.set_font(size='small')
f2.add_label(0.12,0.85,'DRAO Q (N4)',relative=True,size='large',layer='title')
...
f3 = aplpy.FITSFigure('N4_galfacts_u_corrected.fits', figure=fig,
                      subplot=[0.45, 0.4, 0.38, 0.2])

f3.tick_labels.set_font(size='x-small')
f3.axis_labels.set_font(size='small')
f3.add_label(0.15,0.85,'GALFACTS U (N4)',relative=True,size='large',layer='title')
...
f4 = aplpy.FITSFigure('wolUN4.fits', figure=fig,
                      subplot=[0.45, 0.1, 0.38, 0.2])

f4.tick_labels.set_font(size='x-small')
f4.axis_labels.set_font(size='small')
f4.add_label(0.12,0.85,'DRAO U (N4)',relative=True,size='large',layer='title')
...
fig.savefig('s2viscompare.pdf', bbox_inches='tight')
