...
new_cube_header['OBJECT']='GALFACTS S2 Q reduced 1.4GHz'
new_err_header['OBJECT']='GALFACTS S2 Q reduc-err 1.4GHz'

new_hdu=fits.PrimaryHDU(cube_reduced,header=new_cube_header)
new_err_hdu=fits.PrimaryHDU(err_reduced,header=new_err_header)

outfile_image='S2_binned_Q_red.fits'
outfile_err='S2_binned_Q_erred.fits'
