...
new_err_header=header_cube.copy()

new_cube_header['OBJECT']='GALFACTS S1 Q reduced 1.41GHz'
new_err_header['OBJECT']='GALFACTS S1 Q reduc-err 1.41GHz'

new_hdu=fits.PrimaryHDU(cube_reduced,header=new_cube_header)
new_err_hdu=fits.PrimaryHDU(err_reduced,header=new_err_header)

outfile_image='S1_binned_Q_red.fits'
outfile_err='S1_binned_Q_erred.fits'
