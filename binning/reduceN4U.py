...
#Reduces a binned cube to a single-frequency map, averaged between specified channels, syntax reduceS2Q.py start end
...
new_cube_header['OBJECT']='GALFACTS N4 U reduced 1.41GHz'
new_err_header['OBJECT']='GALFACTS N4 U reduc-err 1.41GHz'

new_hdu=fits.PrimaryHDU(cube_reduced,header=new_cube_header)
new_err_hdu=fits.PrimaryHDU(err_reduced,header=new_err_header)

outfile_image='N4_binned_U_red.fits'
outfile_err='N4_binned_U_erred.fits'
