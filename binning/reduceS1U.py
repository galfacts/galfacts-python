...
#Reduces a binned cube to a single-frequency map, averaged between specified channels, syntax reduceS1U.py start end
...
new_cube_header['OBJECT']='GALFACTS S1 U reduced 1.41GHz'
new_err_header['OBJECT']='GALFACTS S1 U reduc-err 1.41GHz'
