...
#Chop off bad bit at the end

i_err=i_err[:,:,50:5200]
q_err=q_err[:,:,50:5200]
u_err=u_err[:,:,50:5200]
v_err=v_err[:,:,50:5200]
weights=weights[:,:,50:5200]
...
np.savetxt('../plots/'+i_in[0:2]+'_dec_noise_cropped_'+str(channel)+'.txt',(i_dec_ratio,q_dec_ratio,u_dec_ratio,v_dec_ratio,dec,channel_number))
