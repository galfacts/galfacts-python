...
outfile="noise_ratio_all_newaxes.pdf"
...
ax1.legend(loc=1)
ax1.text(0.3,0.93,'GALFACTS {0} DQA 3.1.2'.format(filein1[0:2]),ha='center',va='center',transform=ax1.transAxes)
...
majortoplocator= FixedLocator((mfr2[0],mfr2[9],mfr2[19],mfr2[29],mfr2[len(mfr2)-1]))
...
ax2.legend(loc=1)
ax2.text(0.3,0.93,'GALFACTS {0} DQA 3.1.2'.format(filein2[0:2]),ha='center',va='center',transform=ax2.transAxes)
...
majortoplocator= FixedLocator((mfr3[0],mfr3[9],mfr3[19],mfr3[29],mfr3[len(mfr3)-1]))
...
ax3.legend(loc=1)
ax3.text(0.3,0.93,'GALFACTS {0} DQA 3.1.2'.format(filein3[0:2]),ha='center',va='center',transform=ax3.transAxes)
...
majortoplocator= FixedLocator((mfr4[0],mfr4[9],mfr4[19],mfr4[29],mfr4[len(mfr4)-1]))
...
ax4.legend(loc=1)
ax4.text(0.3,0.93,'GALFACTS {0} DQA 3.1.2'.format(filein4[0:2]),ha='center',va='center',transform=ax4.transAxes)
