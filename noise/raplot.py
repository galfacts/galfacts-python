...
filein4=sys.argv[4]
i_ra_ratio4,q_ra_ratio4,u_ra_ratio4,v_ra_ratio4,ra4,channel4=np.loadtxt(filein4)
...
ax4.plot(ra4,i_ra_ratio4,color="black",lw=1,label='I ratio')
ax4.plot(ra4,q_ra_ratio4,color="green",lw=1,label='Q ratio')
ax4.plot(ra4,u_ra_ratio4,color="blue",lw=1,label='U ratio')
ax4.plot(ra4,v_ra_ratio4,color="red",lw=1,label='V ratio')
ax4.legend(loc=1)
